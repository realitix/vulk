...
rm -rf vulk-api/*
python setup.py api
git --git-dir=vulk-api/.git --work-tree=vulk-api git config user.name "realitix Travis User"
git --git-dir=vulk-api/.git --work-tree=vulk-api git config user.email "realitix@gmail.com"
